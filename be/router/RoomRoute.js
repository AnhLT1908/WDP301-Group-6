...
RoomRouter.delete(
  "/delete-room-equipment/:roomId/:utilityId",
  RoomController.DeleteUtilities
);

RoomRouter.get("/view-equipment", RoomController.ViewListEquipment)

RoomRouter.get("/", RoomController.GetAllRoom);
RoomRouter.post("/addRoom", protect, RoomController.addRoom);
RoomRouter.get("/:roomId",  RoomController.getRoomDetail);
